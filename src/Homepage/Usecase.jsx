...
// import usecase7 from "../Images/usecase/usecase8.svg"
...
<div className="flex flex-col gap-5 px-4 md:px-48">
  ...
  <div className="flex flex-row tablet:flex-col w-full gap-5">
    ...
    <div className="usecasecontent  w-[60%] flex flex-col justify-center   gap-4 tablet:w-[100%] tablet:text-center">
      ...
      Staking within the SBC ecosystem involves users locking up their SBC tokens in a designated wallet to support network operations, such as transaction validation and enhancing security. This staking mechanism provides an incentive for users to retain their tokens, as they can earn rewards over time. These rewards can then be reinvested or used to unlock additional features within the ecosystem.  </p>
    </div>
  </div>
  {/* 2 */}
